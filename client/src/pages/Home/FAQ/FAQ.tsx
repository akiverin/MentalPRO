...
const faqData = [
  {
    question:
      "Какие методологии используются для оценки уровня тревожности пользователей?",
    answer:
  ...
  {
    question:
      "Какие технологии обеспечивают безопасность пользовательских данных?",
    answer:
      "Мы используем JWT-токены, шифрование AES-256, а также SOC 2 и GDPR-совместимые протоколы хранения данных.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Да, руководители организаций могут настраивать email уведмоления для осведомления сотрудников.",
  },
  {
