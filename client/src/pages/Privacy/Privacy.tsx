      ...
      <div className="privacy__wrapper">
        ...
        <section className="privacy__section">
          ...
          <p className="privacy__text">
            ...
            Кивериным Андреем Александровичем (далее — Оператор).
          </p>
          <p className="privacy__text">
          ...
          <p className="privacy__text">
            ...
            <TheLink to="/privacy" variant="text">
              https://mentalpro.kiver.net/privacy/
            </TheLink>
            .
          </p>
        </section>
        ...
        <section className="privacy__section">
          ...
          <p className="privacy__text">3.1. Оператор имеет право:</p>
          ...
          <p className="privacy__text">3.2. Оператор обязан:</p>
          <ul className="privacy__list">
            <li>
        ...
        <section className="privacy__section">
          ...
          <div className="privacy-table">
            <div className="privacy-table__row">
              <div className="privacy-table__cell privacy-table__cell--header">
                Цель обработки
              </div>
              <div className="privacy-table__cell">
            ...
            <div className="privacy-table__row">
              ...
              <div className="privacy-table__cell">
                <ul className="privacy-table__list">
                  ...
                  <li>фотографии</li>
                  <li>
                    сведения об образовании, профессии, специальности и
                    квалификации, реквизиты документов об образовании
                  </li>
                  <li>
                    сведения о занимаемых ранее должностях и стаже работы,
                    воинской обязанности, воинском учете
                  </li>
                  <li>
                    сведенья о психическом здоровье и эмоциональном состоянии
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="privacy-table__row">
              ...
              <div className="privacy-table__cell">
                <ul className="privacy-table__list">
                  ...
                  <li>
                    Передача персональных данных лицам, являющиеся
                    представителями компании нанимателя
                  </li>
                </ul>
              </div>
            </div>
        ...
        <section className="privacy__section">
          ...
          <p className="privacy__text">
            ...
            Оператора{" "}
            <TheLink href="mailto:kiverin03@yandex.ru" variant="text">
              kiverin03@yandex.ru
            </TheLink>{" "}
